const translation = {
    ...
    'adoption-process': {
        ...
        'adoption-process-step-one-text': 'Lorem ipsum dolor sit amet, consectetur adipiscing. Phasellus eget convallis lectus. Phasellus eget convallis lectus. Phasellus eget convallis lectus.',
        ...
        'adoption-process-step-three-text': 'Lorem ipsum dolor sit amet, consectetur adipiscing. Phasellus eget convallis lectus. Consectetur adipiscing. Phasellus eget convallis lectus.',
    ...
    'available-dogs': {
        ...
        'text-one': 'För att hjälpa dig att hitta en hund som passar dina förutsättningar har vi tagit fram ett matchningssystem som parar ihop dig med de hundar som passar dig och din livsstil. Allt du behöver göra är att svara på några få, enkla frågor kring dig och din vardag då sköter vi resten. Det går såklart bra att även använda sig av filtreringsfunktionen för att exempelvis visa alla hundar av en specifik storlek, aktivitetsnivå etc.',
        'subtitle-two': 'Är du redo för att adoptera?',
        'find-match': 'Hitta min match',
        'text-two': 'Vi på Paw Patrol är väldigt måna om att de hundar som adopteras kommer till sitt föralltidhem. Många av hundarna har haft en tuff start i livet där de kanske inte fått den stabilitet, trygghet och kärlek de behövt. Därför är det viktigt att du som adoptör tänker igenom ditt beslut noggrant, att du är väl medveten om vad det innebär att adoptera en hund och att du vet om att du har den tid och energi som krävs. Vi har samlat bra och viktig information till dig som funderar på att adoptera, läs gärna igenom den innan du skickar in en intresseanmälan för en hund.',
