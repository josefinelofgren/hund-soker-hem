const translation = {
  ...
  "landing-page": {
    ...
    "homeless-dogs-text":
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse velit felis, euismod in convallis ac, pharetra at mauris. Maecenas id tortor eget odio blandit rutrum nec a tortor. Nunc eget maximus nisi. Praesent ullamcorper odio placerat molestie imperdiet. Etiam nec tortor eu est varius feugiat. Sed tempus accumsan ante, quis sollicitudin nisi rhoncus vitae. Vestibulum sed aliquet ante.",
  ...
  "available-dogs": {
    ...
    "text-one":
      "För att hjälpa dig att hitta en hund som passar dina förutsättningar har vi tagit fram ett matchningssystem som parar ihop dig med de hundar som passar dig och din livsstil. Allt du behöver göra är att svara på några få, enkla frågor kring dig och din vardag då sköter vi resten. Det går såklart bra att även använda sig av filtreringsfunktionen för att exempelvis visa alla hundar av en specifik storlek, aktivitetsnivå med mera.",
  ...
  "about-adoption": {
    ...
    dot: "•",
    "question-one":
      "Har vi den tid som behövs för att ta hand om och få hunden att känna sig trygg och säker tillsammans med oss?",
    "question-two":
      "Kan vi uppfylla hundens behov? Kan vi möta hundens aktiveringsnivå?",
    "question-three":
      "Har vi ekonomi till foder, försäkring, oväntade veterinärvårdskostnader, utrustning, hundkurser med mera?",
    "question-four":
      "Hur ser vi till att hunden får så liten ensamtid som möjligt?",
    "question-five":
      "Är jag medveten om rasens särskilda egenskaper och historia?",
    ...
    "text-three":
      "En hund från oss kostar mellan 2 000 och 12 000 kronor beroende på ålder och egenskaper. Vid försäljning är våra hundar veterinärbesiktade, vaccinerade, id-märkta och vid behov avmaskade.",
  ...
  "find-match": {
    title: "Möt din match",
    subtitle: "200 miljoner hundar saknar idag ett hem",
    description:
      "Genom att svara på frågorna nedan så kan vi ta fram de hundar som finns tillgänliga och som matchar dig och din livsstil- och situation.",
    "question-title-1": "Finns det barn i hushållet?",
    "question-1-option-1": "Nej",
    "question-1-option-2": "Ja",
    "question-title-2": "Om barn finns, i vilken ålder är det yngsta?",
    "question-2-option-1": "Mellan 0 - 7 år",
    "question-2-option-2": "Mellan 7 - 12 år",
    "question-2-option-3": "Från 12 år och uppåt",
    "question-title-3": "Finns det hund i hushållet idag?",
    "question-3-option-1": "Nej",
    "question-3-option-2": "Ja, en eller flera tikar",
    "question-3-option-3": "Ja, en eller flera hanar",
    "question-3-option-4": "Ja, både tik och hane finns",
    "question-title-4": "Finns det katt i hushållet idag?",
    "question-4-option-1": "Nej",
    "question-4-option-2": "Ja",
    "question-title-5": "Hur akitv skulle du uppskatta er vardag?",
    "question-5-option-1": "Låg",
    "question-5-option-2": "Medium",
    "question-5-option-3": "Hög",
  },
  "matched-dogs": {
    title: "Våra hundar",
    description: "",
